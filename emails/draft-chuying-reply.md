# Draft reply — to Chuying (HKU)

**To:** yuchuying@connect.hku.hk
**Cc:** jinwu@hku.hk
...
**"Unpicking the rhythms of tropical forests: remote sensing and AI for phenology at scale"**

This fits the "Next-Generation Frontiers: Integrating Remote Sensing and AI in Ecology" theme nicely, and I can tailor it toward open discussion for the round-tables.

One quick question: it would be helpful to confirm the group's planned flights from Hong Kong to Jinghong so I can book the same connections (via Kunming, I believe).

[If useful: I may take you up on the offer of a formal invitation letter for reimbursement — I'll confirm.]

Thanks again for all the organisation — see you very soon!
