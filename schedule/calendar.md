# Provisional Calendars — China 2026

Provisional and subject to confirmation (flights unbooked; David's exact dates to confirm). Times are local (UK = UTC+1; HK & mainland China = UTC+8). Importable `.ics` files: [../calendar/james.ics](../calendar/james.ics), [../calendar/david.ics](../calendar/david.ics) — regenerate with `python tools/make_calendar.py`.

Legend: ✈ flight · ★ talk/keynote · ● event · ○ free/buffer

## Combined day grid

| Date | Day | James | David |
| --- | --- | --- | --- |
| 22 Jun | Mon | ✈ LHR → HKG (overnight) | — |
| 23 Jun | Tue | Arrive HKG; check in JEN Hotel | — |
| 24 Jun | Wed | ● HK workshop — Day 1 | — |
| 25 Jun | Thu | ● HK workshop — Day 2 | — |
| 26 Jun | Fri | ★ Keynote (AM) · workshop Day 3 | — |
| 27 Jun | Sat | ✈ HKG → Jinghong (via Kunming) w/ HKU group | — |
| 28 Jun | Sun | ● ATBC registration + opening | — |
| 29 Jun | Mon | ● ATBC sessions | — |
| 30 Jun | Tue | ● ATBC sessions | ✈ Munich → Beijing (CA962, dep ~13:00) |
| 1 Jul | Wed | ● ATBC sessions | Arrive Beijing 04:45 (CA962); check in |
| 2 Jul | Thu | ● ATBC sessions | ○ Peking University (tentative) |
| 3 Jul | Fri | ● ATBC field trips | ★ Tsinghua — David's talk + Le Yu |
...
- **Tue 23 Jun** Arrive HKG; check in to JEN Hotel (HKU-covered).
- **Wed 24 – Fri 26 Jun** ● HK pre-ATBC workshop. ★ **Keynote, morning of 26 Jun** (17 min + 3 min Q&A).
- **Sat 27 Jun** ✈ HKG → Kunming → Jinghong with HKU group; check in to Mekong River Jing Land Hotel.
- **Sun 28 Jun – Fri 3 Jul** ● ATBC 2026 (registration 28 Jun; field trips 3 Jul).
...
- **Wed 1 Jul** Arrive Beijing Capital (PEK) 04:45; check in near Tsinghua.
- **Thu 2 Jul** ○ Possibly Peking University (not yet organised).
